...
const PRESETS = [
  ...
  { label: 'Weekly electricity (30 kWh)', cat: 'energy',    type: 'electricity_grid', amount: 30, note: 'Weekly electricity' },
  ...
  { label: 'Weekly general waste (5kg)', cat: 'waste',     type: 'general_waste', amount: 5, note: 'Bin day' },
];
...
const ECO_TIPS = [
  ...
  // Energy
  { cat: 'energy', emoji: '💡', title: 'Switch to LED lighting', desc: 'LEDs use 75–80% less energy than incandescent bulbs and last much longer.', saving: 'Save ~40 kg CO₂e per year per household' },
  { cat: 'energy', emoji: '🌞', title: 'Install solar panels', desc: 'Rooftop solar can supply most of a household\'s electricity needs with near-zero operational emissions.', saving: 'Save 1–2 tonnes CO₂e per year' },
  { cat: 'energy', emoji: '🌡️', title: 'Lower your thermostat', desc: 'Turning your heating down by 1°C can reduce heating energy use by about 8–10%.', saving: 'Save ~230 kg CO₂e per year' },
  { cat: 'energy', emoji: '🔋', title: 'Use a smart power strip', desc: 'Standby electronics consume 5–10% of home energy. Smart strips cut standby power automatically.', saving: 'Save 50–100 kg CO₂e per year' },
  // Food
  ...
  // Waste
  { cat: 'waste', emoji: '🗑️', title: 'Recycle correctly', desc: 'Recycling aluminium uses 95% less energy than producing it from scratch. Always separate waste correctly.', saving: 'Save ~10 kg CO₂e per kg of aluminium recycled' },
  { cat: 'waste', emoji: '🌿', title: 'Start composting', desc: 'Food waste in landfill produces methane, a potent greenhouse gas. Composting dramatically reduces this.', saving: 'Save ~0.5 kg CO₂e per kg composted' },
  { cat: 'waste', emoji: '🔄', title: 'Repair before replacing', desc: 'Repairing broken items instead of buying new avoids the full manufacturing carbon cost of the replacement.', saving: 'Save 50–100% of new product emissions' },
];
